...
Let's get started: open Rhinoceros on Windows and Grasshopper. To launch Grasshopper, either type `Grasshopper` in the Rhino command prompt or navigate in the Standard toolbar to the Grasshopper icon.
...
![Euclidean vector | wikipedia.org](<../../.gitbook/assets/image (47).png>)
...
![Grasshopper](<../../.gitbook/assets/image (205).png>)
