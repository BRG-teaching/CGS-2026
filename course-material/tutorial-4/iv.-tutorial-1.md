...
![Fig.1](../../.gitbook/assets/arch_q.png)
...
![Fig.2](../../.gitbook/assets/arch_circle.jpg)
...
Create FormDiagram with the button ![](../../.gitbook/assets/IGS2_form.png)`Crerate Form Diagram` from the lines. Restrain the two extremity vertices assigning them as supports/anchors with the button ![](../../.gitbook/assets/IGS2_form_select_fixed.png) `Identify Anchors`. Assign one load, -10 kN, with the button ![](../../.gitbook/assets/IGS2_form_assign_forces.png) `Assign Forces`. Press the button ![](../../.gitbook/assets/IGS2_force_from_form.png) `Create Force Diagram` which generated the ForceDiagram highlighted in Fig.3.

![Fig.3](../../.gitbook/assets/arch_force.png)
...
![Fig.5](../../.gitbook/assets/arch_constraint.png)
...
![Fig.8](../../.gitbook/assets/arch_update_both.png)
