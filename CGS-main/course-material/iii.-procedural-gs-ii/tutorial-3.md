...
{% hint style="info" %}
You will find the Rhinoceros file of the canyon with two loads **here**. Or you can simply add one more load in the Rhino file from module I.
{% endhint %}
...
{% hint style="info" %}
You will find the Grasshopper definition [**here**](../ii.-procedural-gs-i/).
{% endhint %}
