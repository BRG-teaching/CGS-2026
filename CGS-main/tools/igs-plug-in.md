...
{% hint style="warning" %}
Close all the Rhino windows you have opened. If you are using **Rhino 7.0**, please execute the following command. We strongly recommend to use **Rhino 7** for this module.
{% endhint %}
